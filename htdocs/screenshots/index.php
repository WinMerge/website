...
<div class="screenshots">
  ...
  <a href="filecmp.png" target="_blank"><img class="image" src="filecmp_small.png" alt="<?php __e('File Comparison');?>" width="305" height="200" border="0"></a>
  ...
  <a href="open-dialog.png" target="_blank"><img class="image" src="open-dialog_small.png" alt="<?php __e('Open-dialog');?>" width="300" height="126" border="0"></a>
  ...
  <a href="foldercmp.png" target="_blank"><img class="image" src="foldercmp_small.png" alt="<?php __e('Folder Comparison Results');?>" width="316" height="200" border="0"></a>
  ...
  <a href="foldercmp_treeview.png" target="_blank"><img class="image" src="foldercmp_treeview_small.png" alt="<?php __e('Folder Compare Tree View');?>" width="285" height="200" border="0"></a>
  ...
  <a href="filecmp_inlinediff.png" target="_blank"><img class="image" src="filecmp_inlinediff_small.png" alt="<?php __e('Highlight Line Diff');?>" width="294" height="200" border="0"></a>
